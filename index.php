...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'trafico') {
    ...
    $last_start_idx = -1; $last_start_call = null; $last_start_utc = null;
    $last_end_idx   = -1; $last_end_utc    = null;
    ...
    if ($active) {
        ...
        $prev_start_idx = -1; $prev_start_call = null; $prev_start_utc = null;
        ...
        <div class="card border-primary small-card">
            <div class="card-body">
			    ...
			    ($puerto >= 21000 && $puerto <= 27000) ) {
                        ...
                        } elseif (($puerto >= 48000 && $puerto <= 60000) ||
          ...
          <?php if (!empty($heard_rows)): ?>
            ...
            <div class="scroll-area mt-2" style="max-height:400px; overflow-y:auto;">
              <table class="table table-sm table-striped align-middle">
                ...
                <tbody>
                  <?php $i=1; $max_qsos = $heard_rows[0]['count']; ?>
